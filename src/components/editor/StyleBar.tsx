...
const styles = StyleSheet.create({
  container: { height: 40, borderBottomWidth: 1, borderBottomColor: '#e5e7eb', backgroundColor: '#f9fafb' },
  row:       { alignItems: 'center', paddingHorizontal: 12, gap: 8 },
  pill:      { paddingHorizontal: 14, paddingVertical: 5, backgroundColor: '#e5e7eb', borderRadius: 20 },
