    ...
    <View style={styles.container}>
      ...
      {errors.length > 0 && (
        <View style={styles.warningsContainer}>
          {errors.map((e, i) => (
            <Text key={i} style={styles.warningText}>⚠️ {e}</Text>
          ))}
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  warningsContainer:   { backgroundColor: '#fff7ed', borderRadius: 8, padding: 10, marginTop: 8 },
  warningText:         { fontSize: 12, color: '#92400e', marginBottom: 2 },
  streamContainer:     { height: 100, backgroundColor: '#f9fafb', borderRadius: 8, padding: 10, marginTop: 8 },
  ...
  openButton:          { backgroundColor: '#6366f1', padding: 16, borderRadius: 12, width: '100%', alignItems: 'center' },
  ...
  errorTitle:          { fontSize: 22, fontWeight: '800', color: '#ef4444', marginBottom: 12 },
